...
22. 其它
    ...
    ![image-20200618202949400](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/image-20200618202949400.png)
...
1. **树**
   ...
   ![img](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/https://xeh1430.github.io/img/tree.png)
...
1. **JVM的内存结构（模型）**
   ...
   >
   > i. 分别随着新方法的调用和返回而增长和缩小
   >
   > ii. 堆栈中的变量仅在创建它们的方法正在运行时才存在
   >
   > iii. 当方法完成执行时它会自动分配和释放
   >
   > iv. 如果此内存已满，Java 会抛出 java.lang.StackOverFlowError 与堆内存相比，访问此内存的速度更快
   >
   > v. 该内存是线程安全的，因为每个线程都在自己的堆栈中运行
...
12. **GC的常见算法，CMS以及G1的垃圾回收过程，CMS的各个阶段哪两个是Stop the world的，CMS会不会产生碎片，G1的优势**

13. **GC每个算法的优缺点和原理(标记清除和标记整理算法的理解以及优缺点)**
...
16. **父类双亲委派机制**
    ...
    ![image-20200618223626021](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/image-20200618223626021.png)
    ...
    ![image-20200619083553313](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/image-20200619083553313.png)
...
8. **volatile（可见性）和synchronized（锁）的区别**
   ...
   ![1554218515504](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/1554218515504.png)
...
7. **事务是怎么控制的？用到分布式事务控制了吗？如何做的？**
   ...
   ![1553048376228](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/1553048376228.png)
