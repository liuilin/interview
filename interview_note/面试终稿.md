...
5. **Java集合之间的区别**
   ...
   ![Java 集合体系](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/Java%20%E9%9B%86%E5%90%88%E4%BD%93%E7%B3%BB.jpg)

   - List 与 Set

     List 中的数据对象有序且可以重复、Set 中的数据对象无序且不可以重复
...
9. **HashMap，HashTable，ConcurrentHashMap的区别**
   ...
   [HashMap与ConcurrentHashMap的区别_XF的专栏-CSDN博客_hashmap和concurrenthashmap的区别](https://blog.csdn.net/xuefeng0707/article/details/40834595)
