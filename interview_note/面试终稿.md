...
2. **请谈谈你对 volatile 的理解（volatile 关键字的作用 | 请你谈谈 JMM）**
   ...
   - 不保证原子性：
     ...
     ![JMM 不保证原子性](https://cdn.jsdelivr.net/gh/liuilin/interview@latest/interview_note/img/JMM%20%E4%B8%8D%E4%BF%9D%E8%AF%81%E5%8E%9F%E5%AD%90%E6%80%A7.jpg)
...
7. **Lock接口有哪些实现类，使用场景是什么。**

8. **可重入锁的用处及实现原理，写时复制的过程，读写锁，分段锁（ConcurrentHashMap中的segment）**

9. **悲观锁，乐观锁，优缺点，CAS有什么缺陷，该如何解决**
