...
9. **HashMap 在高并发下如果没有处理线程安全会有怎样的安全隐患，具体表现是什么（为什么要用 ConcurrentHashMap？）**
   ...
   **HashMap 是线程安全的吗？不安全会导致哪些问题？如何解决？有没有线程安全的并发容器？ConcurrentHashMap 是如何实现的？**
   ...
   3) fail：进行数组判空检查时，会出现线程安全问题。ConcurrentHashMap 还是使用 `U.getObjectVolatile()` 先获取内存中的最新值，然后在进行判断。判断通过后用 CAS 来替换插入值
...
2. 要有很强的留档意识（保存自己的工作成果，备份和同事、领导之间的聊天记录，保存历次报销相关的行政信息、考勤记录）；全程录音（HR 也可能对你本身进行录音，对你的各种行为进行留档的，因此在一些特殊的问题上要谨言慎行，不要留下任何对自己不利的证据，比如说不要轻易承认自己工作中的失误，任何工作都是不完美的。当公司和你产生冲突的时候，HR 一种非常常见的策略就是提出你工作中的问题，这时候有的职场新人可能没有什么经验的。可能会说虽然我有工作失误，但是我们组的其他人也有我还算好的。或者会说一些比如说我加班这么多，我不可能保证所有事情都做得很完美，有失误很正常）
...
3. 不要轻易在任何法律文书上签字
   ...
   因为哪怕这个文件不合情理，除非（不合理）非常严重的话，其他情况一旦在这个文书上签字，就视同于你同意了这个文件上说的所有内容，视同于你你同意他开的各种条件，在大多数情况中基本上你签字就没有回头路了，你想再去维权再去想推翻你这个东西就非常困难了
...
5. 和 HR 之间的任何关键性的沟通一定要走OA系统或者邮件

   而且这个邮件一定是要公司邮箱，而不是个人邮箱，而且最好还要抄送hr部门的最高领导，不然的话对方很有可能说 HR 你们是私人沟通，不代表公司立场。除了OA和邮件上hr说的内容，其他的任何他的口头承诺都是无效

6. 在谈判前详细了解劳动法并且想好自己的底线和筹码

   最基本的是你要懂法，你不懂法就谈不上维护自己的合法权益。你至少应该做的是要去看2018年最新版的《中华人民共和国劳动法》
   那么另外一点是你应该研究一下你当地的劳动局发没发过什么补充性的条文

   另外我觉得还可以去做的一件事情，是你去咨询你们当地的劳动仲裁机构或者劳动者保护机构的一些热线。有官方的组织在做这个事情，你如果连这个都不想做、不愿意去做的话，你就乖乖的接受你们公司给你的任何条件，你根本就没有能和它抗争的能力
...
8. 劳动法是倾向于劳动者一方的要有底气
   ...
   再举个栗子：流氓 HR 的做法，HR 企图用劳动法第 3 章第 25 条，然后来威胁你让你自己滚蛋。流氓hr最常用的是第2和第3小条
   ...
   我觉得对于作为劳动者最好的一种心态是你把劳动仲裁当做一种手里的武器，但你不要轻易去进行劳动仲裁，因为这个事情虽然说现在有的公司还是比较开放的。但是一般的 HR 面对说这个人曾经劳动仲裁过，他都会仔细的看你仲裁过什么样的内容，而且他都会抱有一定的警惕。所以不要轻易去做，也就是说你不要轻易放弃和公司正常的谈判和正常的沟通，哪怕公司显得比较操蛋，但是另一方面你也不要害怕用人单位，要不卑不亢。所以说你要明白一般的公司 HR 是真的不愿意你把这个事闹到劳动仲裁机构的

   > 第二十五条劳动者有下列情形之一的，用人单位可以解除劳动合同：（一）在试用期间被证明不符合录用条件的；（二）严重违反劳动纪律或者用人单位规章制度的；（三）严重失职，营私舞弊，对用人单位利益造成重大损害的；
   > （四）被依法追究刑事责任的。

   ==最后谈不下了，就对人事说，如果不接受我的底线。那么我会和之前的同事合并劳动仲裁，到时候我们是不会接受庭外调解的。直接按照劳动合同走对应的赔偿，同时还有加班补偿等等==
...
[它们当初最忌惮这个劳动仲裁视频！干货分享被违法解雇时的应对之策，里面的预感现在已经被应验！_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV19g411c7zy?p=1&vd_source=4844de7cb051be29fbaf4555af0bbd8b)
...
```
作者：眼罩
链接：https://www.zhihu.com/question/384593047/answer/2311804039
来源：知乎
