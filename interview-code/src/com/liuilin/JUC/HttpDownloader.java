...
public class HttpDownloader {
    ...
    public static void main(String[] args) throws IOException {
        String url = "https://mirrors.tuna.tsinghua.edu.cn/ELK/yum/logstash-2.3/logstash-2.3.0-1.noarch.rpm";
        new HttpDownloader(url, "C:\\Users\\Daniel\\GitHub\\logstash.rpm", 10, 5000).get();
    }
